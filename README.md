...
3. **Depoimentos**: em `src/data/content.js`, substitua os depoimentos de exemplo pelos relatos reais de pacientes/famílias (com autorização deles para uso do nome).
